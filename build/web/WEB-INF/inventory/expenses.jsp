<%-- 
    Document   : expenses
    Created on : Jun 22, 2024, 3:09:23 AM
    Author     : phiona
--%>
...
<head>
    ...
    <!-- Title -->
    <title>Electronnity - Expenses</title>
        ...
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="sales-list.html">Sales<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
