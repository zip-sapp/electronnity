...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>electronnity | uodate-products</title>
                                ...
                                <div class="card-body">
                                    <div class="example-container">
                                        <div class="example-content">
                                            ...
                                            <input type="text" class="form-control" id="productid" name="productid" value="<c:out value='${productDetails.productId}'/>">
                                        </div>
                                        <div class="example-content">
                                            <label for="productname" class="form-label">Product Name</label>
                                            <input type="text" class="form-control" id="productname" name="productname" value="<c:out value='${productDetails.productName}'/>">
                                        </div>
                                        <div class="example-content">   
                                            <label for="description" class="form-label">Product Description</label>
                                            <textarea class="form-control" id="description" name="description"><c:out value='${productDetails.description}'/></textarea>
                                        </div>
                                        <div class="example-content">
                                        ...
                                        <div class="example-content">
                                            ...
                                            <input type="number" class="form-control" id="price" name="price" value="<fmt:formatNumber pattern="#########" value="${productDetails.price}"/>">
                                        </div>
                                        <div class="example-content">
                                            <label for="quantity" class="form-label">Quantity</label>
                                            <input type="number" class="form-control" id="quantity" name="quantity" value="<c:out value='${productDetails.quantity}'/>">
                                        </div>
                                    </div>
                                </div>
                            </form>
