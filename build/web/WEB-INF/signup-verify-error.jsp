...
<head>
    ...
    <title>electronnity | accountverify</title>
       ...
       // Check if page is being refreshed
        window.onload = function() {
            if (performance.navigation.type === 1) {
                window.location.href = 'http://localhost:8080/electronnity/verifyaccount';
            }
        };
    </script>
</head>
                        ...
                        <div class="x-wc-shop-notices e22311-e226 mh7r-3b">
                            <div class="woocommerce-notices-wrapper">
                                <ul class="woocommerce-error" role="alert">
                                    <li>
                                        <strong>ERROR:</strong> Invalid PIN. Please check the PIN provided on your email and try again!
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="x-text x-text-headline e22311-e229-v0 mh7r-1o mh7r-1p mh7r-1q mh7r-1r mh7r-1s mh7r-1t mh7r-1u mh7r-1v mh7r-1w mh7r-3 mh7r-4 mh7r-5">
                            <div class="x-text-content">
                                <div class="x-text-content-text">
                                    <h1 class="x-text-content-text-primary">Verify Account</h1>
                                </div>
                            </div>
                        </div>
                        <form method ="POST" action = "${pageContext.request.contextPath}/completeregistration" class="x-div e22311-e230 mh7r-7 mh7r-8 mh7r-c mh7r-d mh7r-l mh7r-o mh7r-p mh7r-q mh7r-1l">
                                ...
                                <div class="x-text x-text-headline e22311-e254 mh7r-1p mh7r-1r mh7r-1s mh7r-1t mh7r-1v mh7r-1y mh7r-24 mh7r-26 mh7r-29 mh7r-2e mh7r-2r mh7r-2s mh7r-3 mh7r-4 mh7r-5">
                                    <div class="x-text-content">
                                        <div class="x-text-content-text">
                                            ...
                                            Check in Inbox or Spam folder <a target="_blank">This Button Does Nothing</a>.
                                        </span>
                                    </div>
                                </div>
                            </div>
