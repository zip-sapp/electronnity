<%-- 
    ...
    Created on : Jun 15, 2024, 8:55:58 PM
    Author     : nchln
--%>
                ...
                <div id="products-collections-filter" class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                        <div class="single-productsBox">
                            <div class="products-image">
                                <a href="#">
                                    <img src="assets/img/guitar_plush.png" class="main-image" alt="image">
                                    <img src="assets/img/guitar_plush.png" class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                        <div class="single-productsBox">
                            <div class="products-image">
                                <a href="#">
                                    <img src="assets/img/gray-shirt_front.png" class="main-image" alt="image">
                                    <img src="assets/img/gray-shirt_front.png" class="hover-image" alt="image">
                                </a><div></div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                        <div class="single-productsBox">
                            <div class="products-image">
                                <a href="#">
                                    <img src="assets/img/black-cap_front.png" class="main-image" alt="image">
                                    <img src="assets/img/black-cap_front.png" class="hover-image" alt="image">
                                </a><div></div>
                            </div>
                        ...
                        <div class="single-productsBox">
                            <div class="products-image">
                                <a href="${pageContext.request.contextPath}/jacket">
                                    <img src="assets/img/black-jacket_front.png" class="main-image" alt="image">
                                    <img src="assets/img/black-jacket_front.png" class="hover-image" alt="image">
                                </a>
                            </div>
                        ...
                        <div class="single-productsBox">
                            <div class="products-image">
                                <a href="${pageContext.request.contextPath}/hoodie">
                                    <img src="assets/img/black-hoodie_front.png" class="main-image" alt="image">
                                    <img src="assets/img/black-hoodie_front.png" class="hover-image" alt="image">
                                </a><div></div>
                            </div>
                            ...
                            <div class="products-content">
                                ...
                                <a href="${pageContext.request.contextPath}/cart" class="add-to-cart">Add to Cart</a>
                            </div>
                        </div>
                    </div>
                </div>
