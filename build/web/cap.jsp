<%-- 
    Document   : cap
    Created on : Jun 22, 2024, 2:41:11 AM
    Author     : phiona
--%>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="products-details-image">
                            <div class="single-products-details-image">
                                <img src="assets/img/black-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_blue-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_teal-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_green-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_red-cap_front.png" alt="image">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="products-cart-content">
                            <div class="products-cart">
                                <div class="products-image">
                                    <a href="#"><img src="assets/img/sp_black-cap_front.png" alt="image"></a>
                                </div>
                        ...
                        <div class="woocommerce-widget-area">
                            ...
                            <div class="woocommerce-widget collections-list-widget">
                                ...
                                <ul class="collections-list-row">
                                    ...
                                    <li class="active"><a href="#" class="active">Limited Edition</a></li>
                                    <li><a href="#"></a></li>
