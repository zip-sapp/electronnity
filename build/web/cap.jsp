<%-- 
    Document   : cap
    Created on : Jun 24, 2024, 5:49:01 PM
    Author     : Aaron
--%>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="products-details-image">
                            <div class="single-products-details-image">
                                <img src="images/merch-images/black-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="images/merch-images/sp_blue-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="images/merch-images/sp_teal-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="images/merch-images/sp_green-cap_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="images/merch-images/sp_red-cap_front.png" alt="image">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="products-details-desc products-details-desc-sticky">
                            ...
                            <div class="products-color-switch">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="#" title="Teal" class="color-teal"></a></li>
                                ...
                                <ul class="accordion">
                                    <li class="accordion-item">
                                        ...
                                        <div class="accordion-content show">
                                            <p>Elevate your style and shield yourself from the sun with our Classic Cap, the ultimate blend of functionality and fashion. Designed for everyday wear, this versatile cap is perfect for all seasons and occasions, whether you're hitting the gym, going for a casual stroll, or simply adding a sporty touch to your outfit.</p>

                                            <ul>
                                                <li><b>Variety of Colors:</b> Available in a wide range of vibrant colors to match any outfit or personal style.</li>
                                                <li><b>Sun Protection: </b>The curved brim provides effective sun protection, shielding your face and eyes from harmful UV rays.</li>
                                                <li><b>Gift:</b> Ideal for men, women, and teens, the Classic Cap makes a thoughtful and practical gift for friends and family.</li>
                                                <li>Shipping: Free</li>
                                            </ul>
                                        </div>
                        ...
                        <div class="woocommerce-widget-area">
                            ...
                            <div class="woocommerce-widget collections-list-widget">
                                ...
                                <ul class="collections-list-row">
                                    ...
                                    <li class="active"><a href="guitar_plush.jsp" class="active">Limited Edition</a></li>
                                    <li><a href="#"></a></li>
                                    <li><a href="shirt.jsp">Shirt</a></li>
                                    <li><a href="hoodie.jsp">Hoodie</a></li>
                                    <li><a href="jacket.jsp">Jacket</a></li>
                                </ul>
                            </div>
