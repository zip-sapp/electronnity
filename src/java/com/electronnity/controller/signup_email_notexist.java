...
public class signup_email_notexist extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/signup-error-emailacc-notexist.jsp").forward(request, response);
    }
