<%-- 
    ...
    Created on : Jun 22, 2024, 3:11:45 AM
    Author     : phiona
--%>
...
<head>
    ...
    <!-- Title -->
    <title>Electronnity - Product List</title>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="images/neptune.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="images/neptune.png" />
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/black-hoodie_front.png" alt="" style="width:60x;height:60px;">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/black-jacket_front.png" alt="" style="width:60x;height:60px;">
                                            </td>
                                            <td>Windbreaker</td>
                                            <td>12342</td>
                                            <td>Jacket</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/black-cap_front.png" alt="" style="width:60x;height:60px;">
                                            </td>
                                            <td>Signature Cap</td>
                                            <td>12343</td>
                                            <td>Cap</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/gray-shirt_front.png" alt="" style="width:60x;height:60px;">
                                            </td>
                                            <td>Classic Patch Tee</td>
                                            <td>12344</td>
                                            <td>T-shirt</td>
                                            <td>150</td>
                                            <td>XS, S, M, L, XL, XXL</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/guitar_plush.png" alt="" style="width:60x;height:60px;">
                                            </td>
                                            <td>Guitar Plushie</td>
                                            <td>12345</td>
                                            <td>Plush</td>
                                            <td>150</td>
                                            <td>S, M, L</td>
