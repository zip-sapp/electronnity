<%-- 
    ...
    Created on : Jun 21, 2024, 2:57:52 PM
    Author     : nchln
--%>
...
<head>
    ...
    <!-- Title -->
    <title>Electronnity - Create User</title>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        ...
                        <ul class="sub-menu">
                            <li class="active-page">
                                <a href="${pageContext.request.contextPath}/create_user" class="active">Create User</a>
                            </li>
                            <li>
                            ...
                            <div class="card-body">
                                <div class="example-container">
                                    <div class="example-content">
                                        <label for="exampleInputEmail1" class="form-label">Select the specified user.</label>
                                    ...
                                    <div class="example-content">
                                        <label for="exampleInputEmail1" class="form-label">Position (if admin)</label>
                                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                </div>
                            </div>
