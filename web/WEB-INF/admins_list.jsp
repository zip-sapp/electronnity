<%-- 
    Document   : admins-list
    Created on : Jun 21, 2024, 2:51:17 PM
    Author     : nchln
--%>
...
<head>
    ...
    <!-- Title -->
    <title>Electronnity - Admins List</title>
                ...
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active-page">
                                <a href="${pageContext.request.contextPath}/admins_list" class="active">Admins List</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Nicholai Sandoval</td>
                                            <td>+63 991 200 6556</td>
                                            <td>nchlndrsndvl@gmail.com</td>
                                            <td>Co-Owner</td>
                                            <td>    
                                                <button type="button" class="btn btn-danger btn-burger"><i class="material-icons">delete_outline</i></button>    
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Jess Rhyan Tiburcio</td>
                                            <td>+63 915 706 6290</td>
                                            <td>N/A</td>
                                            <td>Co-Owner</td>
                                            <td>    
                                                <button type="button" class="btn btn-danger btn-burger"><i class="material-icons">delete_outline</i></button>    
