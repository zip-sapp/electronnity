<%-- 
    Document   : login
    Created on : 20 Apr 2024, 2:37:40 pm
    Author     : Aaron
--%>
...
<head>
    ...
    <title>electronnity | changepassword</title>
                        ...
                        <div class="x-text x-text-headline e22311-e229-v0 mh7r-1o mh7r-1p mh7r-1q mh7r-1r mh7r-1s mh7r-1t mh7r-1u mh7r-1v mh7r-1w mh7r-3 mh7r-4 mh7r-5">
                            <div class="x-text-content">
                                <div class="x-text-content-text">
                                    <h1 class="x-text-content-text-primary">Forgot Password?</h1>
                                </div>
                            </div>
                        </div>
                        <form method ="POST" action = "${pageContext.request.contextPath}/forget    " class="x-div e22311-e230 mh7r-7 mh7r-8 mh7r-c mh7r-d mh7r-l mh7r-o mh7r-p mh7r-q mh7r-1l">
                        ...
                        <a class="x-anchor x-anchor-toggle mh7r-2v mh7r-2w mh7r-2z mh7r-31 mh7r-32 mh7r-33 mh7r-35 mh7r-37 mh7r-39 mh7r-3a mh7r-3 mh7r-5 mh7r-6" tabindex="0" href ="${pageContext.request.contextPath}/login">
                            <div class="x-anchor-content">
                                <div class="x-anchor-text">
                                    <span class="x-anchor-text-primary">Go Back</span>
                                </div>
                            </div>
                        </a>
                    </div>
