<%-- 
    Document   : hoodie
    Created on : Jun 15, 2024, 9:00:27 PM
    Author     : nchln
--%>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="products-details-image">
                            ...
                            <div class="single-products-details-image">
                                <img src="assets/img/sp_lightblue-hoodie_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_green-hoodie_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_red-hoodie_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_teal-hoodie_front.png" alt="image">
                            </div>
                        </div>
                    </div>
