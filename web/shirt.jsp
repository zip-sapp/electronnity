<%-- 
    Document   : shirt
    Created on : Jun 22, 2024, 1:46:32 AM
    Author     : phiona
--%>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="products-details-image">
                            ...
                            <div class="single-products-details-image">
                                <img src="assets/img/sp_green-shirt.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_red-shirt_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp_blue-shirt_front.png" alt="image">
                            </div>

                            <div class="single-products-details-image">
                                <img src="assets/img/sp-teal shirt.png" alt="image">
                            </div>
                        </div>
                    </div>
